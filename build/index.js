        ...
        tools: [
            {
                ...
                description: "Vercel Status の incident history feed から最近の障害履歴を取得します。",
                inputSchema: {
                    type: "object",
                    properties: {},
                },
            },
            {
                ...
                description: "Vercel の Atom feed を検索し、incident / outage / postmortem 関連の記事を返します。",
                inputSchema: {
                    type: "object",
                    properties: {
                        query: {
                            type: "string",
                            description: "検索キーワード。デフォルトは 'incident' で、関連語も含めて絞り込みます。",
                            default: "incident",
                        },
                    },
                },
            },
            {
                ...
                description: "Vercel Customers ページから顧客事例と掲載企業を取得します。企業名で絞り込みできます。",
                inputSchema: {
                    type: "object",
                    properties: {
                        filter: {
